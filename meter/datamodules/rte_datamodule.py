...
from ..datasets import RTEDataset


class RTEDataModule(BaseDataModule):
    ...
    def setup(self, stage):
        if not self.setup_flag:
            ...
            self.val_dataset = self.dataset_cls(self.text_data_dir, 'validation', max_text_len=self.max_text_len)
